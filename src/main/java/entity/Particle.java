...
public class Particle extends Circle {
    ...
    public Particle(double x, double y) {
        super(x, y, GameConstants.DEFAULT_PARTICLE_RADIUS, Color.BLACK); // ajustez le rayon et la couleur
    ...
    public void applyRandomFluctuation() {
        double fluctuation = GameConstants.DEFAULT_FLUCTUATION; // Ajustez l'amplitude de la fluctuation selon vos
                                                                // préférences
